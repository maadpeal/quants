...
1. **Aritmética Financiera** *(Ponderación: 8)* 🟠
...
1. **Mercados de Capitales** *(Ponderación: 9)* 🔴
   - Estructura y funcionamiento.
   - Actores principales y su rol.

2. **Entidades Financieras y de Seguros** *(Ponderación: 7)* 🟢
   - Tipos de entidades.
   - Funcionamiento y regulación.

3. **Contabilidad** *(Ponderación: 6)* 🟢
   - Principios básicos de contabilidad.
   - Balances y estados de resultados.

4. **Riesgos Financieros** *(Ponderación: 8)* 🟠
   - Tipos de riesgos.
   - Gestión y mitigación.

### B. Instrumentos Financieros: 🟢

1. **Mercados e Instrumentos Financieros** *(Ponderación: 9)* 🔴
   - Tipos de mercados: primarios, secundarios.
   - Instrumentos: acciones, bonos, derivados.

2. **Futuros, Forwards y Opciones** *(Ponderación: 8)* 🟠
   - Definición y diferencias.
   - Uso y aplicación en finanzas.
   
3. **Índices sobre Tipos de Interés** *(Ponderación: 7)* 🟢
   - Concepto y aplicación.
   - Principales índices y su impacto.

4. **Interest Rate Swaps y Curvas de Tipos** *(Ponderación: 8)* 🟠
   - Definición de swap de tasa de interés.
   - Construcción y uso de curvas de tipos.

5. **Caps, Floors y Swaptions** *(Ponderación: 7)* 🟢
   - Instrumentos derivados de tasas de interés.
   - Aplicaciones y valoración.

6. **Curva de Probabilidades de Solvencia e Instrumentos de Crédito** *(Ponderación: 6)* 🟢
   - Concepto de solvencia.
   - Instrumentos para medir y gestionar el crédito.

### C. Fundamentos Computacionales (Avanzados): 🟢

1. **Python (Avanzado)** *(Ponderación: 9)* 🔴
...
1. **Probabilidad y Simulación** *(Ponderación: 8)* 🟠
...
2. **Procesos Estocásticos** *(Ponderación: 7)* 🟢
...
1. **Cálculo Numérico** *(Ponderación: 8)* 🟠
   - Álgebra matricial numérica.
   - Resolución de ecuaciones.
   - Integración y derivación numéricas.
   - Interpolación.

2. **Técnicas de Simulación** *(Ponderación: 9)* 🔴
   - Reducción de varianza.
   - Muestreo por importancia.
   - Ejercicio anticipado.

3. **Cálculo Numérico Avanzado** *(Ponderación: 8)* 🟠
   - Resolución de ecuaciones derivadas en parciales.
   - Técnicas de optimización.

### B. Fundamentos de Valoración: 🟢

1. **Valoración por Replicación y No Arbitraje** *(Ponderación: 9)* 🔴
   - Conceptos básicos y aplicación.

2. **Modelos Discretos** *(Ponderación: 7)* 🟢
   - Modelos matriciales.
   - Árboles binomiales.

3. **Entorno Black** *(Ponderación: 8)* 🟠
   - Aplicación para equity, forwards y swaps.
   - Ajustes de convexidad.

4. **Modelo Normal y Shifted-Lognormal** *(Ponderación: 7)* 🟢
...
1. **Riesgo de Mercado** *(Ponderación: 9)* 🔴
   - Metodologías de medición.
   - Marco y novedades regulatorias.

2. **Riesgo de Crédito y Operacional** *(Ponderación: 8)* 🟠
...
1. **Modelos Regulatorios** *(Ponderación: 7)* 🟢
...
1. **Análisis Cuantitativo** *(Ponderación: 8)* 🟠
   - Estadísticas descriptivas.
   - Modelado predictivo.
   - Backtesting y ajuste de modelos.

2. **Herramientas Financieras Específicas** *(Ponderación: 7)* 🟢
   - Plataformas de trading algorítmico.
   - Herramientas de análisis de riesgo.

3. **Gestión de Proyectos y Habilidades Blandas** *(Ponderación: 6)* 🟢
